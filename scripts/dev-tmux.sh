...
#
#   실행:      wsl bash /mnt/c/Users/admin/dmnsolution-site/scripts/dev-tmux.sh
#   다시 붙기:  wsl tmux attach -t dmnsolution
#   종료:      wsl tmux kill-session -t dmnsolution
set -e

SESSION=dmnsolution
WIN_DIR='C:\Users\admin\dmnsolution-site'
